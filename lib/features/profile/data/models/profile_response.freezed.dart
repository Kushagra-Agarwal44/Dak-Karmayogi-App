...
class _$ProfileUserImpl implements _ProfileUser {
  const _$ProfileUserImpl({
    ...
    this.username,
    this.email,
    @JsonKey(name: 'CONTACTNO') this.contactNo,
    this.division,
    this.region,
    this.circle,
  });
  ...
  @override
  String toString() {
    return 'ProfileUser(studentId: $studentId, firstname: $firstname, lastname: $lastname, username: $username, email: $email, contactNo: $contactNo, division: $division, region: $region, circle: $circle)';
  }
...
abstract class _ProfileUser implements ProfileUser {
  const factory _ProfileUser({
    ...
    final String? username,
    final String? email,
    @JsonKey(name: 'CONTACTNO') final String? contactNo,
    final String? division,
    final String? region,
    final String? circle,
  }) = _$ProfileUserImpl;
